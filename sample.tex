...
\begin{document}
	...
	\begin{titlepage}
		\begin{center}
			...
			\fbox{\rule{0pt}{1.5in} \rule{1.5in}{0pt}} % Placeholder box for Logo
			
			\vspace{1.5cm}
			{\Large \textbf{\uppercase{[Insert University Name]}}} \\
			\vspace{0.5cm}
			...
			\vspace{0.8cm}
			{\huge \textbf{\uppercase{Engineering Marvels of Sri Lanka}}} \\
			\vspace{0.4cm}
