...
\begin{document}
	...
	\begin{titlepage}
		...
		\begin{center}
			...
			% University Logo (Make sure logo.jpg exists in the directory)
			\vspace*{0.5cm}
	...
	Today, the stupa faces severe material degradation. Capillary water absorption draws moisture deep into the porous bricks, dissolving the internal lime mortar matrix. Furthermore, thermal cycling causes micro cracking, reducing the compressive strength of the outer brick layers \cite{munasinghe2018}.
	...
	\begin{thebibliography}{15}
		...
		\bibitem{rajapakse2021} Rajapakse, N. (2021). Bio-inorganic Mortars in Ancient Sri Lankan Masonry. \textit{Journal of Heritage Materials}, 14(3), 88-102.
		...
		\bibitem{silva2020} Silva, R. (2020). Material Characterization of Sigiriya Fresco Plasters. \textit{Archaeological Science Reports}, 11(1), 45-59.
		...
		\bibitem{wijesuriya1998} Wijesuriya, G. (1998). \textit{Buddhist Stupas in Sri Lanka}. Department of Archaeology.
